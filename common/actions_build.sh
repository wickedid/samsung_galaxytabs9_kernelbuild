...
export PATH="$GITHUB_WORKSPACE/samsung_galaxytabs9_kernelbuild/prebuilts/clang/host/linux-x86/clang-r450784e/bin:$PATH"
export PATH="$GITHUB_WORKSPACE/samsung_galaxytabs9_kernelbuild/prebuilts/kernel-build-tools/linux-x86/bin:$PATH"
...
if [ ! -d AnyKernel3 ]; then
  git clone --depth=1 https://github.com/wickedid/AnyKernel3.git -b kalama
fi
